"""
This is an example of how waveforms will be generated. 
For generating a neural network, I will simply be using the SEOBNRv4 
appxt. The tutorial can be found here: 
